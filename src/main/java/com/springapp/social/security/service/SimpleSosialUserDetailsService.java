package com.springapp.social.security.service;
 ...
 */
public class SimpleSosialUserDetailsService implements SocialUserDetailsService {

    private static final Logger LOGGER = LoggerFactory.getLogger(SimpleSosialUserDetailsService.class);
    private UserDetailsService userDetailsService;

    public SimpleSosialUserDetailsService(UserDetailsService userDetailsService) {
