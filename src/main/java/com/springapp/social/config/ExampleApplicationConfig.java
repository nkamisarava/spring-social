...
public class ExampleApplicationConfig implements WebApplicationInitializer{
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        ServletRegistration.Dynamic dispatcher = servletContext.addServlet(DISPATCHER_SERVLET_NAME, new DispatcherServlet((org.springframework.web.context.WebApplicationContext) rootContext));
        ...
        servletContext.addListener(new ContextLoaderListener((org.springframework.web.context.WebApplicationContext) rootContext));
    }
}
